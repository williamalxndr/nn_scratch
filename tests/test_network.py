...
@pytest.mark.parametrize("input_size",  range(3, 300, 100))   
@pytest.mark.parametrize("output_size", range(1, 100, 50))   
@pytest.mark.parametrize("batch_size",  range(1, 1000, 100))   
...
def test_network_learning(input_size, output_size, batch_size, epochs, training_batch_size):
    ...
    net.add_layer(Linear(input_size, 32))
    net.add_layer(Sigmoid(32))
    net.add_layer(Linear(32, 124))
    net.add_layer(ReLU(124))
    net.add_layer(Linear(124, output_size))
